...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1611533725, 1254838, 0x1e0ffff0, 1, 85 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000008731b579190f08fe5ed6d1ffa1e836b6043ab57f0e4f0783b70de978581"));
        assert(genesis.hashMerkleRoot == uint256S("907f76540d6448882aac14a0f9713f68d469b281b88729b23e84fb9f1ae0cad2"));
        ...
        vSeeds.emplace_back("144.126.212.18");   // Node 1
        vSeeds.emplace_back("144.126.212.247"); // Node 2
        // vSeeds.emplace_back("eu.boxycoin.org");    // EU node
        // vSeeds.emplace_back("us.boxycoin.org");    // USA node
        // vSeeds.emplace_back("asia.boxycoin.org");  // Asia node
        // vSeeds.emplace_back("ru.boxycoin.org");    // Russia node
        // vSeeds.emplace_back("seed.boxycoin.org");  // Cryptomorpher
        ...
        checkpointData = {
          {
            { 0, uint256S("000008731b579190f08fe5ed6d1ffa1e836b6043ab57f0e4f0783b70de978581")},
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet.boxycoin.io");
