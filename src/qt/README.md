This directory contains the BoxycoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Boxycoin UI.
...
ClientModel is used by the main application `boxycoingui` and several models like `peertablemodel`.
...
Handles URI based application switching (e.g. when following a boxycoin:... link from a browser).
