 ...
 * between boxycoind, and boxycoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/boxycoin/boxycoin>";
    const std::string URL_WEBSITE = "<https://boxycoin.org>";
