...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " boxycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  boxycoin-tx [options] <hex-tx> [commands]  Update hex-encoded boxycoin transaction\n" +
            "or:     boxycoin-tx [options] -create [commands]   Create hex-encoded boxycoin transaction\n" +
            "\n";
