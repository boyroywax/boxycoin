# Support for Output Descriptors in Boxycoin Core

Since Boxycoin Core v2.0.0, there is support for Output Descriptors in the
...
on Boxycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Boxycoin Core wallets, a convenience function `combo` is
